...

{
    ...
    config.core.system.security.hardenUSB.rules = ''
        ...
        allow id 03f0:03c0 serial "0123456789" name "HyperX Cloud Jet" hash "ffvGlNc4UFQTYOznlcheHYwyFxaHnGFSlUQomtLGax4=" parent-hash "w0s+/0l185H3y20XSMXWN6ut4SGmlt7G3DiDnvIKJAo=" with-interface { 01:01:00 01:02:00 01:02:00 01:02:00 01:02:00 03:00:00 } with-connect-type "unknown"
        allow id 152d:2590 serial "00A12345AFD0" name "Generic USB Device" hash "F9cKTQ2pi+0YsWMb2rjZThF2uNW2eP6TlvV1nweBsh4=" parent-hash "/wEAALcWgNDZSgOyp1ns2y+xeLpaF5P61j/IvuOpIUo=" with-interface { 08:06:50 08:06:62 } with-connect-type "unknown"
