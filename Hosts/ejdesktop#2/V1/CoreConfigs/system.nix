...

{
    ...
    config.core.system.security.hardenSudo.enable = false;
    config.core.system.security.hardenOpenSSH.enable = true;
    config.core.system.security.hardenOpenSSH.harden = false;
    config.core.system.security.hardenRoot.enable = false;
    config.core.system.security.hardenFirewall.enable = false;
    ...
    config.core.system.security.hardenPam.enable = false;
