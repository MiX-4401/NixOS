...

{
    ...
    desktop.packages.hyprland.sensitivity = 0.0;
    desktop.packages.hyprland.scrollFactor = 0.7;
    
    # desktop.bundles options
    desktop.bundles.office.enable   = true; 
    desktop.bundles.desktop.enable  = true; 
    desktop.bundles.gaming.enable   = false; 
    desktop.bundles.extra.enable    = true; 
    desktop.bundles.social.enable   = false; 
    desktop.bundles.troubleshooting.enable = false;
}