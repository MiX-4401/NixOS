...
Singleton {
    ...
    readonly property string flamingo:  "#7af2cdcd"
    readonly property string pink:       "#f5c2e7"
    readonly property string mauve:      "#cba6f7"
    readonly property string red:        '#7af38ba8'
    readonly property string maroon:     '#24eba0ad'
    readonly property string peach:      "#fab387"
    readonly property string yellow:     '#c1f9e1af'
