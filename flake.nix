{
    ...
    in { 
        ...
        # Devopment shells
        devShells.${system} = {
            forensics = import ./Modules/Shells/Forensics/default.nix { inherit pkgs; };                # Forensics development shell
            troubleshooting = import ./Modules/Shells/Troubleshooting/default.nix { inherit pkgs; };    # Troubleshooting shell
        };
        ...
        nixosConfigurations.ejdesktop = myLib.mkHost {    # Uses my custom mkHost function to take care of boilerplate
            ...
            username = "ejradford";
            system = system;
            modules = [ ./Hosts/ejdesktop/V4/configuration.nix ];
            specialArgs = { };
        };
        ...
        nixosConfigurations.ejlaptop = myLib.mkHost {    # Uses my custom mkHost function to take care of boilerplate
            ...
            username = "ejradford";
            system = system;
            modules = [ ./Hosts/ejlaptop/V3/configuration.nix disko.nixosModules.disko ];
            specialArgs = { };
        };
